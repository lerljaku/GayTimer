...
namespace GayTimer.Controls
{
    ...
    public class ItemsControl : ContentView
    {
        ...
        // Data
        private readonly Label m_noItemsLabel;
        ...
        public ItemsControl()
        {
            ...
            m_noItemsLabel = new Label
            {
                HorizontalTextAlignment = TextAlignment.Center,
                VerticalTextAlignment = TextAlignment.Center
            };

            m_noItemsLabel.SetBinding(Label.StyleProperty, new Binding(nameof(ItemStyle), source: this));
            m_noItemsLabel.SetBinding(Label.TextProperty, new Binding(nameof(PlaceholderText), source: this));

            Content = m_noItemsLabel;
        }
        ...
        private Xamarin.Forms.Layout<View> GetOrCreateLayoutContainer(bool createDefaultContainer)
        {
            ...
            if (createDefaultContainer && m_stack == null)
            {
        ...
        {
            if (m_stack != null && oldValue != newValue)
            {
                m_stack.Orientation = newValue;
            }
        }
